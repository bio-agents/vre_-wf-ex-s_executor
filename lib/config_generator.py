...
infrastructure = setInfrastructure(12, 4, "/VM/path/where/main/executable/is/going/to/be/MyAgent.py", cloud)
input_files, arguments = setInputs(inputs)
agent = setAgent(owner, keywords, infrastructure, input_files, arguments)
print(dumps(JSONSerializer.serialize(agent), indent=2))
