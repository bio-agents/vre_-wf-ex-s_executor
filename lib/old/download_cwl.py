...
abs_path = "/Users/laurarodrigueznavas/BSC/generic_wrapper/"
ro_path = abs_path + "tests/cwl/kfdrc_alignment/ro/ro-crate-metadata.jsonld"
...
if __name__ == '__main__':
    ...
    rule = re.search(r"\b(examples/)\b", url)
    index = rule.start()
    abs_path = url[:index]
    sub_path = url[index:]
    ...
    for elem in elements:
        if "examples" in elem["@id"] or "agents" in elem["@id"]:
