...
class WfExS(Agent):
    ...
    def run(self, input_files, input_metadata, output_files, output_metadata):
        """
        The main function to run the WfExS agent.
        ...
        try:
            ...
            if len(self.execution_provenance) != 0:
                # Create and validate the output files from Agent execution
                # TODO
            ...
            errstr = "VRE WfExS agent execution failed. See logs."
            logger.fatal(errstr)
